...
<div class="container">
    ...
    <div class="card-deails" style="border-radius:20px;">
        ...
        <!-- <?php if(!empty($this->session->flashdata('success'))) { ?>
			...
			<?php }
            ?> -->
            <form action="<?php echo base_url('user/booking')?>" method="post">
                    ...
                    <div class="col-lg-6">
                        <div class="card p-4  venue-card">
                            <div>
                                ...
                                <p>All Events Venue in <?php echo $row->city?></p>
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <small class="fw-bold">Per Plate</small>
                            </div>
                            <hr>
                            <div class="row mt-3">
...
<div class="container">
    ...
    ?>
            <div class="swiper-slide" style="border-radius:20px;">
                ...
                <div>
                    <a href="venue_details?id=<?php echo $row->venue_id?>">
