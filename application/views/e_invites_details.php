...
<div class="container">
    ...
    <div class="card-deails" style="border-radius:20px;">
        ...
        <!-- <?php if(!empty($this->session->flashdata('success'))) { ?>
			...
			<?php }
            ?> -->
            <form action="<?php echo base_url('user/booking_e_invites')?>" method="post">
                <input type="hidden" name="id" value="<?php echo $row->invites_id ?>">
                    ...
                    <div class="col-lg-6">
                        <div class="card p-4  venue-card">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <small class="fw-bold">Per Card</small>
                            </div>
                            <hr>
                            <div class="row mt-3">
                                <h4 class="text-center fw-bold">Get Quotation form</h4>
                                <hr>
                                <div class="col-lg-6">
                                ...
                                <div class="col-lg-6 mb-3">
                                    <input type="date" id="date_picker" name="date" class="form-control " placeholder="Event Date" title="Event Date"
                                        required>
                                </div>
                                <hr>
                                <div class="col-lg-6 mb-3">
                                    <input type="text" name="guest" min="50" class="form-control"
                                        placeholder="No. of Card's(50)" required>
                                </div>
                                
                               
                                <hr>
                                <div class="text-center">
                                    <button class="btn btn-primary fw-bold text-center">Get Quotation </button>
