                ...
                <div class="row">
                    <div class="col-lg-6 col-md-5 col-sm-6">
                        <div class="white-box text-center"><img src="assets/img/<?php echo $row->image?>"
                                class="img-fluid" name="pro_img" alt="" style="height:100vh; border-radius:12px;"></div>
                    ...
                    <div class="col-lg-6">
                        <div class="card p-4  venue-card">
                            <div>
                                ...
                                <p>Wedding <?php echo $row->name?> in <?php echo $row->city?></p>
                            ...
                            <a target="_blank" href=" https://wa.me/923348993918?text=I am interested to buy this product I spotted on the PlaneServeParty gallery. Let me know how to proceed. <?php echo $row->name;
                            ?>  <?php $url = $protocol . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];
                            echo $url; ?> ">
                               <button class=" btn btn-success fw-bold text-center text-white"><i class="fab fa-whatsapp"></i> Chat with Designer</button>
                               <a href=""></a>
                               </a>
                            </div>
                            <hr>
                            <div>
                            <h4 class="fw-bold">How to Order?</h3>
                            <p>Use the “Chat with Designer” button to get in touch with the designer.</p>
                            </div>
                            <!-- <div class="row mt-3">
                                ...
                                <hr>
                                <div class="text-center">
                                    <button class="btn btn-primary fw-bold text-center">Check Availability </button>
                                </div>
                            </div>
                        </div> -->
                        </div>
...
<div class="container">
    ...
    ?>
            <div class="swiper-slide" style="border-radius:20px;">
                ...
                <div>
                    <a href="shop_details?id=<?php echo $row->shop_id?>">
