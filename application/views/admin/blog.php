        ...
        <div class=" grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div>
                      <a href="<?php echo base_url('admin/add_blog')?>"><button class="btn btn-primary mb-4">Add Blog</button></a>  
                    </div>
                        ...
                        <table class="table table-striped table-borderless" id="table_categories">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <a href="edit_blog?id=<?php echo $row->blog_id?>">
                                         <button class="btn btn-primary px-4 py-2">Edit</button>
                                        </a>
                                        <a href="deleteblog?id=<?php echo $row->blog_id?>"
