        ...
        <div class=" grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div>
                      <a href="<?php echo base_url('admin/add_venue')?>"><button class="btn btn-primary mb-4">Add Venue</button></a>  
                    </div>
                        ...
                        <table class="table table-striped table-borderless" id="table_categories">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <a href="edit_venue?id=<?php echo $row->venue_id?>">
                                         <button class="btn btn-primary px-4 py-2">Edit</button>
                                        </a>
                                        <a href="deletevenue?id=<?php echo $row->venue_id?>"
