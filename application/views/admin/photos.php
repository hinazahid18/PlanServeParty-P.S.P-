        ...
        <div class=" grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div>
                      <a href="<?php echo base_url('admin/add_photo')?>"><button class="btn btn-primary mb-4">Add Photo</button></a>  
                    </div>
                        ...
                        <table class="table table-striped table-borderless" id="table_categories">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <a href="edit_photo?id=<?php echo $row->photo_id?>">
                                         <button class="btn btn-primary px-4 py-2">Edit</button>
                                        </a>
                                        <a href="deletephoto?id=<?php echo $row->photo_id?>"
