...
<div class="container">
    ...
    <div class="card-deails" style="border-radius:20px;">
        <div class="card-body">
            <form action="<?php echo base_url('user/booking_vendor')?>" method="post">
                    ...
                    <div class="col-lg-6">
                        <div class="card p-4  venue-card">
                            <div>
                                ...
                                <p>All Events Vendor in <?php echo $row->city?></p>
...
<div class="container">
    ...
    ?>
            <div class="swiper-slide" style="border-radius:20px;">
                ...
                <div>
                    <a href="vendor_details?id=<?php echo $row->vendor_id?>">
